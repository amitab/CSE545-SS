...
public class InvokeQueryChaincode {
	...
	public static void main(String args[]) {
		try {
			...
			String[] arguments = { "TXN1", "1234", "03/24/2020", "00:00", "69" };
			...
			Collection<ProposalResponse>  responsesQuery = channelClient.queryByChainCode("fabcar", "queryAllTransactions", null);
			...
			Thread.sleep(10000);
			String[] args1 = {"TXN1"};
			Collection<ProposalResponse>  responses1Query = channelClient.queryByChainCode("fabcar", "queryTransaction", args1);

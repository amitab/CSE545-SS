...
<div class="content-wrapper">
	...
	<div class="col-md-12" id="page-content" align="center">
        ...
        <form:form cssClass="form-horizontal" id="RegistrationExternal" action="/Admin/ExternalRegister" method="post" modelAttribute="employeeForm">
          <fieldset>
            <div><p>${message}</p></div>
          ...
          <div class="form-group">
            <div class="col-lg-7 col-lg-offset-2">
              ...
              <input type="submit" formaction="/Admin/ExternalRegister" formmethod="post" value="Register" />

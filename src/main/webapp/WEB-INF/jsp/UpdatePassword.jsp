			...
			<div class="panel panel-primary">
 				 ...
 				 <p>${message }</p>
	  			 <div class="panel-body">
					<form class="form-horizontal" id="UpdatePassword" action="/changepassword" method="post">
			  			<fieldset>
						    ...
						    <div class="form-group">
						      ...
						      <div class="col-lg-5">
						        <input type="password" class="form-control" name="" id="" placeholder="Confirm New Password" required>
						      </div>
						    </div>
			  				 <div class="form-group">
